...
namespace ABC.LeaveManagement.Data.Migrations
{
    ...
    [Migration("20161221190740_Added_Identity")]
    partial class Added_Identity
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ABC.LeaveManagement.Data.IdentityModel.LeaveManagementUser", b =>
                {
            ...
            modelBuilder.Entity("ABC.LeaveManagement.Data.IdentityModel.LeaveManagementUser", b =>
                {
                    b.HasOne("ABC.LeaveManagement.Core.Entities.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ABC.LeaveManagement.Data.IdentityModel.LeaveManagementUser")
                        .WithMany("Claims")
